                ...
                postData.map( (post, index) => {return <div className='card mb-4'>
                    ...
                    <div className='card-footer'>
                        <div className='row'>
                            ...
                            <div className='col-4'>
                                <button className='btn btn-outline-dark w-100 rounded-pill' on> <i class="bi bi-chat-fill"></i> Comment</button>
                            </div>
                            <div className='col-4'>
                                <button className='btn btn-outline-dark w-100 rounded-pill' onClick={() => addShare(index)}> <i class="bi bi-share-fill"></i> Share</button>
                            </div>
                        </div>

                        <input type="text" onKeyDown={addCmmt} className='form-control my-3 border-dark-subtle' placeholder='Add a comment...'/>
                        {Cmmt.map((cmt) => { return <div className='d-flex justify-content-between align-items-center ms-2'> <p>{cmt}</p> </div>})}
                    </div>
